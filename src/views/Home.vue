  ...
  <div>
    <div class="home">
      <div class="paralax-box">
        <md-button class="arrow-button md-icon-button" href="#intro">
          <md-icon class="arrow-icon md-size-3x">keyboard_arrow_down</md-icon>
        </md-button>
      </div>
    </div>
    <div class="home-content" id="mid">
      <div id="intro" class="empty-tag"></div>
